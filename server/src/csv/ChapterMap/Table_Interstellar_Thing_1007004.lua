local lua_values = 
 { 
    ...
    x = {8,13,3,8,8,14,14,2,2,9,7,9,7,},
    y = {8,8,8,2,14,7,8,7,8,2,2,15,15,},
    ...
    event = {0,500721,500722,500725,500726,704101,704102,704103,704104,704105,704106,704107,704108,},
