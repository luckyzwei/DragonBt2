local lua_values = 
 { 
    ...
    x = {2,7,7,8,9,10,8,9,10,},
    y = {5,5,6,4,4,3,6,7,7,},
    icon = {'0','ins_monster_01','ins_monster_01','ins_case_01','ins_case_01','ins_case_01','ins_case_01','ins_case_01','ins_case_01',},
    changeicon = {'0','0','0','0','0','0','0','0','0',},
    name = {'0','敌人','敌人','普通宝箱','普通宝箱','普通宝箱','普通宝箱','普通宝箱','普通宝箱',},
    type = {1,3,3,6,6,6,6,6,6,},
    initialtype = {0,0,0,0,0,0,0,0,0,},
    initial = {'0','0','0','0','0','0','0','0','0',},
    delayed = {0,0,0,0,0,0,0,0,0,},
    trigger = {0,0,0,1,1,1,1,1,1,},
    passby = {0,0,0,0,0,0,0,0,0,},
    show = {0,0,0,0,0,0,0,0,0,},
    event = {0,500501,500502,501101,501102,501103,501104,501105,501106,},
    priority = {1,1,1,1,1,1,1,1,1,},
    story = {0,0,0,0,0,0,0,0,0,},
    journal = {'0','0','0','0','0','0','0','0','0',},
    tips = {'0','此处被一队实力普通的敌人占据。\n击败他们才能通过此处。','此处被一队实力普通的敌人占据。\n击败他们才能通过此处。','0','0','0','0','0','0',},
    remarks = {'0','0','0','0','0','0','0','0','0',},
    removetype = {0,0,0,0,0,0,0,0,0,},
    removerelation = {'0','0','0','0','0','0','0','0','0',},
    remove = {'0','0','0','0','0','0','0','0','0',},
    establish = {'0','0','0','0','0','0','0','0','0',},
    modify = {'0','0','0','0','0','0','0','0','0',},
    dispel = {'0','0','0','0','0','0','0','0','0',},
