local lua_values = 
 { 
    ...
    x = {9,7,6,6,5,5,5,5,3,3,2,2,1,1,},
    y = {6,6,1,10,3,5,7,9,4,8,2,9,5,7,},
    ...
    event = {0,500749,707101,707102,707103,707104,707105,707106,707107,707108,707201,707202,707203,707204,},
